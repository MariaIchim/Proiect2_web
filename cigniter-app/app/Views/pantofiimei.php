		...
		<div class="colorlib-product">
			<div class="container">
				<div class="row row-pb-md">
					<?php 
					foreach($pantofi as $perechepantofi)
					{ 
					?>
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<a href="#" class="prod-img">
								<img src="<?php  echo $perechepantofi['imagine'];  ?>" class="img-fluid" alt="Free html5 bootstrap 4 template" style="width:300px;height:300px">
							</a>
							<div class="desc">
								<h2><a href="#"><?php  echo $perechepantofi['nume'];  ?></a></h2>
								<span class="price">Marimea:<?php echo $perechepantofi['marime']; ?></span>
								<span class="price"><?php echo $perechepantofi['pret']; ?> lei</span>
								<?php
								if (isset($user))
								{
								?>
								<div class="row">
									<div class="col-lg-6">
										<a href="/edit/<?php echo $perechepantofi['id'] ?>" class="btn btn-primary">Edit</a>
									</div>
									<div class="col-lg-6">
										<a href="/delete/<?php echo $perechepantofi['id'] ?>" class="btn btn-danger" onclick=' return confirm("esti sigur ca vrei sa stergi?");'>Delete</a>
									</div>
								</div>
								<?php
								}
