        ...
        <div class="row">
			...
			<div class="col-md-6">
				...
				<div class="contact-wrap">
					<h3>Inregistrare</h3>
					<form action="/stocareuser" method='POST'class="contact-form">
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<input name="parola" type="password" id="parola" class="form-control" placeholder="Introduceti parola!" required>
								</div>
							</div>
							<div class="col-sm-12">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<input type="submit" value="Inregistreaza-te" class="btn btn-primary">
								</div>
							</div>
						</div>
					</form>		
